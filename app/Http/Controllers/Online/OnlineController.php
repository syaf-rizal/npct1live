...
class OnlineController extends Controller
{
    ...
    public function getRestOnlineServiceContainer($id)
    {
        ...
        $containerTrackingRest = Curl::to(env('URISEGMENT') . 'tracking-container')
            ...
            ->WithTimeout(300)
            ->post();
        $arrContextTrackingContainer = json_decode($containerTrackingRest, true); 
        $arrContextTrackingContainerStatus = $arrContextTrackingContainer['status']; 
        if($arrContextTrackingContainerStatus)
        {
            $arrContextTrackingContainerData = $arrContextTrackingContainer['data'];
            $arrData['tracking']['isFound'] = TRUE;
            $arrData['tracking']['collections']['status'] = $arrContextTrackingContainerData['status'];
            $arrData['tracking']['collections']['direction'] = $arrContextTrackingContainerData['direction'];
            $arrData['tracking']['collections']['in'] = [
                "transport_type" => $arrContextTrackingContainerData['in']['transport_type'],
                "transport_id" => $arrContextTrackingContainerData['in']['transport_id'],
                "transport_service" => $arrContextTrackingContainerData['in']['transport_service'],
                "transport_gatein" => $arrContextTrackingContainerData['in']['transport_gatein'],
                "transport_gateout" => $arrContextTrackingContainerData['in']['transport_gateout'],
                "line" => $arrContextTrackingContainerData['in']['line'],
                "pod" => $arrContextTrackingContainerData['in']['pod'],
                "pol" => $arrContextTrackingContainerData['in']['spod'],
                "order_no" => $arrContextTrackingContainerData['in']['order_no'],
                "cont_isocode" => $arrContextTrackingContainerData['in']['cont_isocode'],
                "cont_status" => $arrContextTrackingContainerData['in']['cont_full_empty'],
                "cont_weight" => $arrContextTrackingContainerData['in']['cont_weight'],
                "cont_position" => $arrContextTrackingContainerData['in']['cont_position'],
                "cont_reefer" => $arrContextTrackingContainerData['in']['cont_reefer'],
                "cont_reefer_temp" => $arrContextTrackingContainerData['in']['cont_reefer_temp'],
                "cont_imdg" => $arrContextTrackingContainerData['in']['cont_imdg'],
                "cont_imdg_value" => $arrContextTrackingContainerData['in']['cont_imdg_value'],
                "cont_oog" => $arrContextTrackingContainerData['in']['cont_oog'],
                "cont_oog_value" => $arrContextTrackingContainerData['in']['cont_oog_value'],
                "cont_gatein" => $arrContextTrackingContainerData['in']['cont_gatein'],
                "customer" => $arrContextTrackingContainerData['in']['customer_name'],
                "seal" => $arrContextTrackingContainerData['in']['seal'],
                "vessel_name" => $arrContextTrackingContainerData['in']['vessel_name'],
                "vessel_voyage" => $arrContextTrackingContainerData['in']['vessel_voyage'],
                "vessel_eta" => $arrContextTrackingContainerData['in']['vessel_eta'],
                "vessel_etd" => $arrContextTrackingContainerData['in']['vessel_etd'],
                "vessel_ata" => $arrContextTrackingContainerData['in']['vessel_ata'],
                "vessel_atd" => $arrContextTrackingContainerData['in']['vessel_atd'],
                "customs_type" => $arrContextTrackingContainerData['in']['customs_type'],
                "customs_no" => $arrContextTrackingContainerData['in']['customs_no'],
                "customs_date" => $arrContextTrackingContainerData['in']['customs_date'],
                "cont_imdg_remark" => $arrContextTrackingContainerData['in']['cont_imdg_remark'],
                "remark" => $arrContextTrackingContainerData['in']['remark']
            ];
            $arrData['tracking']['collections']['out'] = [
                "transport_type" => $arrContextTrackingContainerData['out']['transport_type'],
                "transport_id" => $arrContextTrackingContainerData['out']['transport_id'],
                "transport_service" => $arrContextTrackingContainerData['out']['transport_service'],
                "transport_gatein" => $arrContextTrackingContainerData['out']['transport_gatein'],
                "transport_gateout" => $arrContextTrackingContainerData['out']['transport_gateout'],
                "line" => $arrContextTrackingContainerData['out']['line'],
                "pod" => $arrContextTrackingContainerData['out']['pod'],
                "pol" => $arrContextTrackingContainerData['out']['spod'],
                "order_no" => $arrContextTrackingContainerData['out']['order_no'],
                "cont_isocode" => $arrContextTrackingContainerData['out']['cont_isocode'],
                "cont_status" => $arrContextTrackingContainerData['out']['cont_full_empty'],
                "cont_weight" => $arrContextTrackingContainerData['out']['cont_weight'],
                "cont_position" => $arrContextTrackingContainerData['out']['cont_position'],
                "cont_reefer" => $arrContextTrackingContainerData['out']['cont_reefer'],
                "cont_reefer_temp" => $arrContextTrackingContainerData['out']['cont_reefer_temp'],
                "cont_imdg" => $arrContextTrackingContainerData['out']['cont_imdg'],
                "cont_imdg_value" => $arrContextTrackingContainerData['out']['cont_imdg_value'],
                "cont_oog" => $arrContextTrackingContainerData['out']['cont_oog'],
                "cont_oog_value" => $arrContextTrackingContainerData['out']['cont_oog_value'],
                "cont_gateout" => $arrContextTrackingContainerData['out']['cont_gateout'],
                "customer" => $arrContextTrackingContainerData['out']['customer_name'],
                "seal" => $arrContextTrackingContainerData['out']['seal'],
                "vessel_name" => $arrContextTrackingContainerData['out']['vessel_name'],
                "vessel_voyage" => $arrContextTrackingContainerData['out']['vessel_voyage'],
                "vessel_eta" => $arrContextTrackingContainerData['out']['vessel_eta'],
                "vessel_etd" => $arrContextTrackingContainerData['out']['vessel_etd'],
                "vessel_ata" => $arrContextTrackingContainerData['out']['vessel_ata'],
                "vessel_atd" => $arrContextTrackingContainerData['out']['vessel_atd'],
                "customs_type" => $arrContextTrackingContainerData['out']['customs_type'],
                "customs_no" => $arrContextTrackingContainerData['out']['customs_no'],
                "customs_date" => $arrContextTrackingContainerData['out']['customs_date'],
                "cont_imdg_remark" => $arrContextTrackingContainerData['out']['cont_imdg_remark'],
                "remark" => $arrContextTrackingContainerData['out']['remark']
            ];
        }
        else if($arrContextTrackingContainerStatus == 400 || $arrContextTrackingContainerStatus == 401)
        {
            $arrData['tracking']['isFound'] = FALSE;
        }
        else
        {
            $arrData['tracking']['isFound'] = FALSE;
    ...
    public function getRestOnlineServiceEir($id)
    {
        ...
        $arrParams = explode("|", $arrParams);
        $payloads = [
            'vesselCode' => $arrParams[0],
            'voyage' => strtoupper($arrParams[1]),
            'direction' => strtoupper($arrParams[2]),
            'unitId' => strtoupper($arrParams[3])
        ];
        $containerEirRest = Curl::to(env('URISEGMENT') . 'eir')
            ->withOption('SSL_VERIFYHOST', false)
            ->withHeaders(array(
                'Accept' => 'application/json', 
                'Content-Type' => 'application/json', 
        ...
        $arrContextEir = json_decode($containerEirRest, true);
        $arrContextEirStatus = $arrContextEir['status']; 
        if($arrContextEirStatus == 200)
        {
            $arrContextEirData = $arrContextEir['collections']['eirAttribute'];
            $arrData['eir']['isFound'] = TRUE;
            $arrData['eir']['collection'] = [
                "direction" => $arrContextEirData['direction'],
                "cont_no" => $arrContextEirData['cont_no'],
                "cont_isocode" => $arrContextEirData['cont_isocode'],
                "cont_status" => $arrContextEirData['cont_status'],
                "cont_position" => $arrContextEirData['cont_position'],
                "vessel_name" => $arrContextEirData['vessel_name'],
                "voyage" => $arrContextEirData['voyage'],
                "etb" => $arrContextEirData['etb'],
                "consignee" => $arrContextEirData['consignee'],
                "trucking" => $arrContextEirData['trucking'],
                "truck_id" => $arrContextEirData['truck_id'],
                "truck_gatein" => $arrContextEirData['truck_gatein'],
                "truck_gateout" => $arrContextEirData['truck_gateout'],
                "cont_gatein" => $arrContextEirData['cont_gatein'],
                "cont_gateout" => $arrContextEirData['cont_gateout'],
                "gross_weight" => $arrContextEirData['gross_weight'],
                "eir_no" => $arrContextEirData['eir_no'],
                "line" => $arrContextEirData['line'],
                "pod" => $arrContextEirData['pod'],
                "pol" => $arrContextEirData['pol'],
                "seal" => $arrContextEirData['seal'],
                "imdg_class" => $arrContextEirData['imdg_class'],
                "imdg_un" => $arrContextEirData['imdg_un'],
                "oog" => $arrContextEirData['oog'],
                "damage_code" => $arrContextEirData['damage_code'],
                "damage_description" => $arrContextEirData['damage_description'],
                "reefer_temp" => $arrContextEirData['reefer_temp'],
                "customs_type" => $arrContextEirData['customs_type'],
                "customs_no" => $arrContextEirData['customs_no'],
                "customs_date" => $arrContextEirData['customs_date']
            ];
            $arrData['eir']['link'] = $arrContextEir['collections']['link'];
        }
        else if($arrContextEirStatus == 400 || $arrContextEirStatus == 401)
        {
            $arrData['eir']['isFound'] = FALSE;
        }
        else
        {
            $arrData['eir']['isFound'] = FALSE;
    ...
    public function getRestOnlineServiceVesselSchedulex($id)
    {
        $arrParams = Crypt::decryptString($id);
        $arrParams = explode("|", $arrParams);
        $vesselScheduleRestByRequest = Curl::to('https://econ.npct1.co.id/npct1rest/api/vesselSchedule')
            ->withHeaders(array('Content-Type: application/json'))
            ->withData([
                'vessel' => $arrParams[0],
            ...
            ->asJson(true)
            ->post();
        $arrContextVesselSchedule = $vesselScheduleRestByRequest;
        $arrContextVesselScheduleStatus = $arrContextVesselSchedule['status'];
        $arrContextVesselScheduleCollections = $arrContextVesselSchedule['collections']['schedule'];
        if($arrContextVesselScheduleStatus == 200)
        {
            $arrData['vesselSchedule']['isFound'] = true;
            if(!empty($arrContextVesselScheduleCollections))
            {
                for($i = 0; $i < count($arrContextVesselScheduleCollections); $i++) 
                {
                    $arrData['vesselSchedule']['collections']['data'][] = [
                        'vessel_name' => $arrContextVesselScheduleCollections[$i]['name'],
                        'line' => '-', //$arrContextVesselScheduleCollections[$i]['name'],
                        'voyage_in' => $arrContextVesselScheduleCollections[$i]['voyageIn'],
                        'voyage_out' => $arrContextVesselScheduleCollections[$i]['voyageOut'],
                        'service'=> $arrContextVesselScheduleCollections[$i]['serviceIn'],
                        'status' => $arrContextVesselScheduleCollections[$i]['status'],
                        'eta' => $arrContextVesselScheduleCollections[$i]['estimateTimeArrival'],
                        'ata' => $arrContextVesselScheduleCollections[$i]['actualTimeArrival'],
                        'etd' => $arrContextVesselScheduleCollections[$i]['estimateTimeDeparture'],
                        'atd' => $arrContextVesselScheduleCollections[$i]['actualTimeDeparture'],
                        'open_stacking' => $arrContextVesselScheduleCollections[$i]['yardOpeningTime'],
                        'closing_document' => $arrContextVesselScheduleCollections[$i]['closingDocument'],
                        'closing_physic' => $arrContextVesselScheduleCollections[$i]['closingPhysic']
                    ];
                }
            }
            else
            {
                $arrData['vesselSchedule']['isFound'] = false;
                $arrData['vesselSchedule']['collections']['data'] = [];   
            }
        }
        else
    ...
    public function getRestOnlineServiceVesselSchedule($id)
    {
        ...
        $vesselScheduleRestByRequest = Curl::to(env('URISEGMENT') . 'vessel-schedule-post')
            ->withOption('SSL_VERIFYHOST', false)
            ->withHeaders(array(
                'Accept' => 'application/json', 
                'Content-Type' => 'application/json', 
            ...
            ->WithTimeout(300)
            ->post();
        $arrContextVesselSchedule = json_decode($vesselScheduleRestByRequest, true);
        ...
        if($arrContextVesselScheduleStatus == 200)
        {
            ...
            if(!empty($arrContextVesselScheduleCollections))
            {
                for($i = 0; $i < count($arrContextVesselScheduleCollections); $i++) 
                {
                    $arrData['vesselSchedule']['collections']['data'][] = [
                        'vessel_name' => $arrContextVesselScheduleCollections[$i]['name'],
                        'line' => $arrContextVesselScheduleCollections[$i]['liner'],
                        'voyage_in' => $arrContextVesselScheduleCollections[$i]['voyageIn'],
                        'voyage_out' => $arrContextVesselScheduleCollections[$i]['voyageOut'],
                        'service'=> $arrContextVesselScheduleCollections[$i]['serviceIn'],
                        'status' => $arrContextVesselScheduleCollections[$i]['status'],
    ...
    public function setEmailWhistle(Request $request)
    {
        ...
        $valid = array('tName', 'tEmail', 'tPhone', 'tCompany', 'tCategory', 'tChronology');
        if(in_array($request->tName, $valid))
        {
            exit();
        }
        else if(in_array($request->tName, $valid))
        {
            exit();
        }
        else if(in_array($request->tPhone, $valid))
        {
            exit();
        }
        else if(in_array($request->tEmail, $valid))
        {
            exit();
        }
        else if(in_array($request->tCompany, $valid))
        {
            exit();
        }
        else if(in_array($request->tChronology, $valid))
        {
            exit();
        }
        else if(in_array($request->tCategory, $valid))
        {
            exit();
        }
        else if(in_array($request->email, $valid))
        {
            exit();
        }
        else if(in_array($request->name, $valid))
        {
            exit();
        }
        else if(in_array($request->phone, $valid))
        {
            exit();
        }
        else if(in_array($request->category, $valid))
        {
            exit();
        }
        else if(in_array($request->chronology, $valid))
        {
            exit();
        }
        else if(in_array($request->company, $valid))
        {
            exit();
        }
        else
        {
            if($request->tCategory == 'Gratification')
            {
                $data['tName'] = $request->tName;
                $data['tPhone'] = $request->tPhone;
                $data['tEmail'] = $request->tEmail;
                $data['tCompany'] = $request->tCompany;
                $data['tChronology'] = $request->tChronology;
                $data['tCategory'] = $request->tCategory;
                
                $data['gEmployee'] = $request->gEmployee;
                $data['gRecSend'] = $request->gRecSend;
                $data['gRecName'] = $request->gRecName;
                $data['gSendName'] = $request->gSendName;
                $data['gRecComp'] = $request->gRecComp;
                $data['gSendComp'] = $request->gSendComp;
                $data['gRecAddr'] = $request->gRecAddr;
                $data['gSendAddr'] = $request->gSendAddr;
                $data['gRecEmp'] = $request->gRecEmp;
                $data['gSendEmp'] = $request->gSendEmp;
                $data['gRecDep'] = $request->gRecDep;
                $data['gSendDep'] = $request->gSendDep;
                $data['gSendPos'] = $request->gSendPos;
                $data['gRecPos'] = $request->gRecPos;
                $data['gType'] = $request->gType;
                $data['gDate'] = $request->gDate ." ".$request->gTime;
                $data['gLoc'] = $request->gLoc;
                $data['gEst'] = $request->gEst;
                $data['gDesc'] = $request->gDesc;
                $data['filename'] = $request->filename;
    
                Mail::send('email2', $data, function ($m) use ($data) {
                    $m->from('notification@npct1.co.id', 'Mail'); 
                    $m->to(array('gratification@npct1.co.id'), 'Whistleblowing Committee')->subject('[NPCT1] New Whistle Blowing Report at '.date("d F Y"));
                    if($data['filename'] != ''){
            ...
            else
            {
                ...
                Mail::send('email', $data, function ($m) use ($data) {
                    $m->from('notification@npct1.co.id', 'Mail'); 
                    $m->to('whistleblowing@npct1.co.id')->subject('[NPCT1] New Whistle Blowing Report at '.date("d F Y"));
                    if($data['filename'] != ''){
                        $m->attach(Storage::disk('public')->path($data['filename']));
                    }
                });
    ...
    public function uploadSubmit(Request $request)
    {
        ...
        return response()->json(array('files' => str_replace('public/', '', $filename), 'path' => Storage::disk('public')->path($filename)), 200);
    }
    ...
    public function getDownloadEirByRequest($id)
    {
        $url = 'https://api.npct1.co.id/trucking/download/' . $id;
        $fileName = $id.'.pdf';
