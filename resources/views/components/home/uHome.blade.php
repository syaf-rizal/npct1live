...
<header>
    @if(count($slider) > 0)
        <div class="owl-carousel owl-theme" id="myslider">
        @for($i = 0; $i < count($slider); $i++)
            <div class="item">
                <img src="{{ Storage::url("images/" . $slider[$i]['banner_filename']) }}">
                @if(!empty($slider[$i]['banner_title']) && strtoupper($slider[$i]['banner_title']) != 'NONE')
                <div class="cover">
                    <div class="container">
...
<section class="logistics logistics-ench w-border-b pb-10">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <nav>
                    <div class="nav nav-tabs" id="nav-tab1" role="tablist">
                        <a class="nav-item nav-link active" id="nav-home-tab" data-toggle="tab" href="#nav-home" role="tab" aria-controls="nav-home" aria-selected="true">Recent News</a>
                        <a class="nav-item nav-link" id="nav-profile-tab" data-toggle="tab" href="#nav-profile" role="tab" aria-controls="nav-profile" aria-selected="false">Tender News</a>
                    </div>
                </nav>
            ...
            <div class="col-sm-12 col-md-12 col-lg-12 text-center">
                <div class="owl-carousel owl-theme" id="feature-carousel">
                    <div class="item">
                        ...
                        <h4>About Us</h4>
                        <p style="text-align: justify;">The Tanjung Priok Port in North Jakarta, which handles more than half of the total Indonesia volume, has become overloaded over the years. The development of New Priok will bring Jakarta's port facilities up to par with other world-class ports and provide new network connectivity opportunity to shipping lines. It will significantly strengthen Indonesia's logistics chain competitiveness and lead to a better trade environment.</p>
                    </div>
                    <div class="item">
                        <img src="{{ asset('images/port.png') }}" class=" mx-auto d-block" alt="Our Services" style="width: auto !important;">
                        <h4>Our Services</h4>
                        <p style="text-align: justify;">New Priok Container Terminal One (NPCT1) is the first terminal of Indonesia's New Priok development and will be well-positioned to provide best-in-class port services to its customers, partners and other stakeholders.</p>
                    </div>
                    <div class="item">
                        <img src="{{ asset('images/tarif-simulation.png') }}" class=" mx-auto d-block" alt="Tarif Simulation" style="width: auto !important;">
                        <h4>Tarif Simulation</h4>
                        <p style="text-align: justify;">This online tool assists shipper or consignee in order to estimate the amount payable for Import or Export transactions implemented in NPCT1</p>
                    </div>
                </div>
            </div>
        </div>
