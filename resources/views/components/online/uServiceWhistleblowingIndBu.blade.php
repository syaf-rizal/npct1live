                ...
                <div class="tab-content" id="nav-tabContent1">
                    ...
                    <div class="tab-pane fade show active" id="tarif" role="tabpanel" aria-labelledby="tarif-tab">
                            ...
                            <div class="row margin-reduce">
                                <div class="col-lg-12 col-md-12 col-sm-12">
                                    <p>
                                    Seseorang (karyawan, kontraktor, vendor, klien, atau pemangku kepentingan lain yang relevan) melaporkan suatu perbuatan yang salah, ilegal, atau aktivitas tidak etis yang dapat merugikan sebuah organisasi. Whistle Blowing diatur dalam Kode Etik Perusahaan yang tercakup dalam Peraturan Perusahaan NPCT1.
                                    </p>
                                </div>
                            </div>
    ...
    <div class="row hide" data-step="1" data-title="Reporter Information">
        <div class="jumbotron">
            <div class="form-group">
                <label class="etd-paidthrough color-blue">Name / Nama *</label>
...
baru sukses terkirim
    ...
    <div class="row hide" data-step="2" data-title="I Would Like to Report">
        <div class="jumbotron">
            <div class="form-group">
            <label class="etd-paidthrough color-blue">Silahkan Pilih Kategori Laporan Anda:
            </label>
            <br/>
            <label>
    ...
    <div class="row hide" data-step="3" data-title="Attachment">
        <div class="jumbotron">
            <div class="form-group">
                <label class="etd-paidthrough color-blue">Kronologis singkat kejadian:
                    <br/>
            ...
            <div align="right">
                <i>Max Lenght 1000 character</i>
            </div>
            <br/>
            <br/>
            <input type="file" />
            <label><i>*Jika anda mempunyai alat bukti mohon dilampirkan dengan file tipe (pdf, jpeg, jpg, png, mp4)</i></label>
            <label><i>*maximal tipe file 5MB</i></label>
    </div>
    ...
    <div class="row hide" data-step="4" data-title="Summary">
        <div class="jumbotron">
            <div class="form-group">
                <label class="etd-paidthrough color-blue">Are you sure the data bellow is correct ?</label>
            </div>
            <div class="form-group">
                <table>
                    <tr>
    ...
    <button type="button" onclick="inputData(); " id="btnNext"  class="btn btn-success js-btn-step" data-orientation="next"></button>
      </div>
    </div>
  </div>
</div>
